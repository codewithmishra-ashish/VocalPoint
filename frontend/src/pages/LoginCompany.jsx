            ...
            <Form className="space-y-5">
              <div>
                <Field
                  ...
                  className="w-full p-4 rounded-xl bg-gray-800 text-white placeholder-gray-500"
                />
              ...
              <button
                ...
                className="w-full py-4 rounded-xl font-bold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 flex items-center justify-center gap-2"
              >
